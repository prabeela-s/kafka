 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.1-cp1-standalone.jar io.confluent.examples.streams.WordCountLambdaExample
 * }
 * </pre>
...
public class WordCountLambdaExample {
    ...
    static final String inputTopic = "texts";
    static final String outputTopic = "word-count";
